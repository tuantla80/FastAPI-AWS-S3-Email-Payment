...
Revision ID: 0384fc1f31b4
Revises: 
Create Date: 2023-08-13 09:55:23.440473
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('approved', 'pending', 'rejected', name='state'), server_default='pending', nullable=False),
